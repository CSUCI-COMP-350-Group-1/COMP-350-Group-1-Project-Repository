...
import com.example.myapplication3.RoomListScreen
import com.example.myapplication3.RoomViewModel
...
fun MainApp() {
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable("studyRoom") {
                RoomListScreen(viewModel = roomViewModel, navController = navController)
            }
        }
    }
}
